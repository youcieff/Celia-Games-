...
import {  IconTarget, IconHourglass, IconTrophy , IconSeaBattle } from '../../components/icons/GameIcons';
                    ...
                    <div className="px-4 grid grid-cols-3 items-center py-4 mb-2">
                        ...
                        <div className="flex justify-center">
                            <div className="flex items-center gap-2 glass-card px-3.5 py-1.5 rounded-2xl border border-white/10 shrink-0">
                                <IconSeaBattle size={18} className="text-[var(--accent)]" />
                                <span className="text-xs font-black gradient-text">حرب الغواصات</span>
                            </div>
                        </div>
